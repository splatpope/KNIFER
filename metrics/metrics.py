...
def get_activations(data, model, 
    ...
    # Make sure 'data' can be used as is
    # adapt to dataloader if needed
...
def calculate_activation_statistics(data, model,
    batch_size = BATCH_SIZE,
    dims = 2048,
    device = 'cpu', num_workers = 1):
...
def FID(data_1, data_2, batch_size, dims, device, num_workers=1):
